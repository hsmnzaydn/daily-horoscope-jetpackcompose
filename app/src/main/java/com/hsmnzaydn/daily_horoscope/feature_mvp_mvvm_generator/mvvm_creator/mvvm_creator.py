...
def generateView(viewmodelName,packageName,viewType):
    if viewType == "Fragment":
        ...
        utility.writeFile(viewmodelName+"Fragment",helper.generateFragmentViewCode(packageName,viewmodelName,viewType))
...
def generateViewModelPart(viewmodelName,packageName):
    utility.createFile(viewmodelName+"VM")
    utility.writeFile(viewmodelName+"VM",helper.generateViewModelCode(packageName,viewmodelName))
    utility.moveFileToFolder(viewmodelName+"VM",viewmodelName.lower())
